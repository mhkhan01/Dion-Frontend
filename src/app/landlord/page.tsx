...
export default function PartnerDashboard() {
  ...
  useEffect(() => {
    if (activeTab === 'contact-info' && user && !hasLoadedContactInfo) {
      console.log('Fetching partner data for contact-info tab');
      fetchPartnerData();
  ...
  const fetchData = async () => {
    try {
      ...
      console.log('Partner profile query result:', { landlordProfile, profileError });
      ...
      if (landlordProfile?.full_name) {
        console.log('Setting partner name to:', landlordProfile.full_name);
        setPartnerName(landlordProfile.full_name);
      } else {
        console.log('No full_name found in partner profile:', landlordProfile);
      }
      ...
      if (propertiesError) {
        ...
        console.log('Fetched properties with activity column:', propertiesData);
  ...
  const fetchPartnerData = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        console.log('Partner data fetched:', landlordData);
        ...
        console.log('No partner data found, using user data');
        setPartnerFullName(user?.full_name || '');
        setContactInfo({
          company_name: '',
          company_email: '',
  ...
  const handleContactInfoUpdate = async () => {
    ...
    try {
      ...
      if (result.error) {
        ...
        console.log('Partner contact information updated successfully');
  ...
  const fetchConfirmedBookings = async () => {
    ...
    try {
      ...
      if (bookedPropertiesError) {
        ...
        console.log('Fetched confirmed bookings:', bookedPropertiesData);
      ...
      case 'add-property':
        return (
          <div className="space-y-4 lg:space-y-6">
            <div>
              <h2 className="text-xl lg:text-2xl font-semibold text-booking-dark mb-2 font-sans">Add New Property</h2>
              <p className="text-sm lg:text-base text-booking-gray font-sans">Create a new property listing</p>
            </div>
            ...
            <div className="bg-white rounded-xl lg:rounded-2xl p-6 lg:p-8 shadow-lg border border-gray-100">
              <div className="text-center">
                ...
                <h3 className="text-base lg:text-lg font-semibold text-booking-dark mb-2 font-sans">Create Property Listing</h3>
                <p className="text-sm lg:text-base text-booking-gray mb-6 font-sans">Add a new property to start receiving bookings.</p>
                <button 
