    ...
    <>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-white py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-12">
        <div className="w-full flex justify-center">
          ...
          <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#0B1D37] mb-2 sm:mb-4 leading-tight">
            Who We Serve
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-[#4B4E53] max-w-3xl mx-auto leading-relaxed mb-6 sm:mb-8">Solving accommodation problems for organisations across the UK - from emergency placements to long-term projects</p>
          <h3 className="text-lg sm:text-2xl md:text-3xl font-bold text-[#0B1D37] mb-6 sm:mb-10">Our Core Sectors</h3>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-12 lg:gap-16 mb-6 sm:mb-8">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xs sm:text-lg sm:text-xl font-bold text-[#0B1D37] mb-2 sm:mb-3">
                Construction & Engineering Companies
              </h4>
              <p className="text-xs sm:text-sm md:text-base lg:text-base text-[#4B4E53] leading-tight sm:leading-relaxed">
                ...
                <div className="grid grid-cols-2 gap-4 lg:gap-8 items-center justify-items-center">
                  ...
                  <div className="text-left lg:pr-4 justify-self-end">
                    ...
                    <div className="flex flex-col gap-2 sm:gap-4 sm:flex-row justify-start">
                      ...
                      >
                        <img src="/google-play.webp" alt="Google Play" loading="eager" className="w-6 h-6 mr-2 sm:mr-3" />
