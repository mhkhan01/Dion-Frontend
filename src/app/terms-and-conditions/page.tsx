        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="mb-6 sm:mb-12">
            <div className="flex items-center mb-2 sm:mb-6">
              ...
              <h2 className="text-xs sm:text-2xl font-bold text-[#4B4E53]">About These Terms</h2>
            </div>
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">1.1 Who We Are</h3>
              ...
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">1.2 Agreement to Terms</h3>
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">
              ...
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">1.3 Other Terms That Apply</h3>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
                <li><strong>Privacy Policy:</strong> explains how we handle your personal data</li>
                <li><strong>Cookie Notice:</strong> explains our use of cookies</li>
                <li><strong>Client Terms and Conditions:</strong> apply when you register as a client or make a booking request</li>
                <li><strong>Partner Terms and Conditions:</strong> apply when you register as a property partner or list properties</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-6 sm:mb-12">
            <div className="flex items-center mb-2 sm:mb-6">
              ...
              <h2 className="text-xs sm:text-2xl font-bold text-[#4B4E53]">Using Our Website</h2>
            </div>
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">2.1 What You Can Use It For</h3>
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">The Website provides information about our accommodation booking services and allows you to:</p>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
              ...
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">2.2 What This Website Is Not</h3>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
              ...
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">2.3 Changes to the Website</h3>
          ...
          <div className="mb-6 sm:mb-12">
            <div className="flex items-center mb-2 sm:mb-6">
              ...
              <h2 className="text-xs sm:text-2xl font-bold text-[#4B4E53]">Acceptable Use</h2>
            </div>
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">3.1 You Must Not:</h3>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
              ...
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">3.2 Consequences of Misuse</h3>
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">We reserve the right to:</p>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
          ...
          <div className="mb-6 sm:mb-12">
            <div className="flex items-center mb-2 sm:mb-6">
              ...
              <h2 className="text-xs sm:text-2xl font-bold text-[#4B4E53]">Intellectual Property</h2>
            </div>
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">4.1 Our Content</h3>
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">
              ...
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">4.2 What You Can Do</h3>
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">You may view and print content for personal, non-commercial use only.</p>
              
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">4.3 What You Cannot Do</h3>
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">You must not:</p>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
          ...
          <div className="mb-6 sm:mb-12">
            ...
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">The Website may contain links to third-party websites. We are not responsible for:</p>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
          ...
          <div className="mb-6 sm:mb-12">
            ...
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">6.1 Website Provided "As Is"</h3>
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">We provide the Website on an "as is" basis. We do not guarantee that:</p>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
              ...
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">6.2 What We Are Not Liable For</h3>
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">To the fullest extent permitted by law, we are not liable for:</p>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
              ...
              <h3 className="text-[8px] sm:text-xl font-semibold text-[#4B4E53] mb-2 sm:mb-4">6.3 Nothing in These Terms:</h3>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
          ...
          <div className="mb-6 sm:mb-12">
            <div className="flex items-center mb-2 sm:mb-6">
              ...
              <h2 className="text-xs sm:text-2xl font-bold text-[#4B4E53]">Indemnity</h2>
            </div>
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <p className="text-[7px] sm:text-base">
          ...
          <div className="mb-6 sm:mb-12">
            <div className="flex items-center mb-2 sm:mb-6">
              ...
              <h2 className="text-xs sm:text-2xl font-bold text-[#4B4E53]">Data Protection and Privacy</h2>
            </div>
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">We process personal data in accordance with:</p>
              <ul className="list-disc pl-6 mb-2 sm:mb-4 text-[7px] sm:text-base">
          ...
          <div className="mb-6 sm:mb-12">
            <div className="flex items-center mb-2 sm:mb-6">
              ...
              <h2 className="text-xs sm:text-2xl font-bold text-[#4B4E53]">Changes to These Terms</h2>
            </div>
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">
          ...
          <div className="mb-6 sm:mb-12">
            <div className="flex items-center mb-2 sm:mb-6">
              ...
              <h2 className="text-xs sm:text-2xl font-bold text-[#4B4E53]">Governing Law and Jurisdiction</h2>
            </div>
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <p className="text-[7px] sm:text-base">
          ...
          <div className="mb-6 sm:mb-12">
            <div className="flex items-center mb-2 sm:mb-6">
              ...
              <h2 className="text-xs sm:text-2xl font-bold text-[#4B4E53]">Right to Refuse Service</h2>
            </div>
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <p className="text-[7px] sm:text-base">
          ...
          <div className="mb-6 sm:mb-12">
            ...
            <div className="text-[#4B4E53] leading-tight sm:leading-relaxed">
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">If you have questions about these Terms or need to report misuse of the Website, contact us:</p>
              <p className="mb-2 sm:mb-4 text-[7px] sm:text-base">
                <strong>Booking Hub</strong><br />
